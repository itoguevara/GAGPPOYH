...
<!-- Dependiendo de la opcion que se elija en el menu, se mostrara un contenido diferente, 
    ...
    @switch($opcionvar)
        @case(0) <!--  En este caso se muestra el formulario de simpatizantes, el cual es un componente de blade que se encuentra en resources/views/components/userauth/tcsolicitud.blade.php -->
            <x-userauth.reportes.simpatizantes.simpasearchrpt :opcionvar="$opcionvar ?? 0" :recordsimpatizantes="$recordsimpatizantes ?? null" :id_simpatizante="'-1'"/>
             @break
        @case(2) <!--  En este caso se muestra el formulario de edición de solicitud de tramites consulares, el cual es un componente de blade que se encuentra en resources/views/components/userauth/tcsolicitudedit.blade.php -->            
            <x-userauth.simpatizantes.simpatizantedataentry :opcionvar="$opcionvar ?? 0" :recordsimpatizantes="$recordsimpatizantes ?? null" :id_simpatizante="'-1'"/>        
            @break
        @default
    @endswitch
